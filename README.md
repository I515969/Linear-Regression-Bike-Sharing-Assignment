...
- Multiple linear regression algorithm is applied and following inference were derived:
    - Training data has R-squared value as **83.6%**
    - Testing data has R-squared value as **79.56%**
    - Error terms normally distributed around zero validating key assumption of linear regression
    - This shows model is a good fit and not overfitting 
